...
export default function EnterPinScreen() {
    ...
    const ref = useBlurOnFulfill({pin, cellCount: CELL_PIN_INPUT});
    ...
    const handleAcceptPin = async () => {
        Alert.alert(
            ...
            [
                ...
                { text: "Đồng ý", onPress: () => authenticate().then() }
            ],
            { cancelable: true }
        );
    }
        ...
        <SafeAreaView style={{flex: 1, backgroundColor:"#fff"}}>
            ...
            >
                <View className="flex-1 items-center justify-center ">
                    ...
                    <Button disabled={!acceptPin} size="$4" theme="active" onPress={handleAcceptPin}>
                        {acceptPin ? "Xác thực" : "Nhập mã PIN"}
                    </Button>
                </View>
            </KeyboardAvoidingView>
        </SafeAreaView>
