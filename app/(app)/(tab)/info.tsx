...
import {Button, Paragraph, XStack, YStack, Separator, Spinner} from "tamagui";
import {FontAwesome6, Ionicons, Feather, MaterialCommunityIcons, AntDesign  } from '@expo/vector-icons';
import {_VerifyUserStatus} from "@/lib/@type";
import {useRouter} from "expo-router";
import {useQuery} from "@tanstack/react-query";
import authAPI from "@/api/auth";
import { maintainWarning } from "@/lib/hooks/reuseFunc";
        ...
        <>
            <LayoutScrollApp title="Hồ sơ" >
                <YStack gap={4} marginTop={24} paddingBottom={52}>
                    ...
                    <Paragraph fontWeight={700} fontSize={20} marginVertical={16}>Quyền lợi</Paragraph>
                    <YStack gap="$4">
                    ...
                    <YStack gap="$4">
                            ...
                            <XStack alignItems="center" justifyContent="space-between" gap="$4" flex={1}>
                                <XStack alignItems="center" gap="$4">
                                    ...
                                    <YStack>
                                        ...
                                        <Paragraph fontSize={12} lineHeight={16} color={DefaultColor.slate[400]}>Giải đáp các thắc mắc của bạn</Paragraph>
                                    </YStack>
                                </XStack>
                                <XStack gap="$2" alignItems="center">
                                    <FontAwesome6 name="angle-right" size={20} color={DefaultColor.slate[400]}/>
                                </XStack>
                            </XStack>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={maintainWarning}>
                            <XStack alignItems="center" justifyContent="space-between" gap="$4" flex={1}>
                                <XStack alignItems="center" gap="$4">
                                    ...
                                    <YStack>
                                        ...
                                        <Paragraph maxWidth={200} fontSize={12} lineHeight={16} color={DefaultColor.slate[400]}>Điền vào mẫu yêu cầu và chúng tôi sẽ liên hệ lại với bạn</Paragraph>
                                    </YStack>
                                </XStack>
                                <XStack gap="$2" alignItems="center">
                                    <FontAwesome6 name="angle-right" size={20} color={DefaultColor.slate[400]}/>
                        ...
                        <TouchableOpacity onPress={maintainWarning}>
                            <XStack alignItems="center" justifyContent="space-between" gap="$4" flex={1}>
                                <XStack alignItems="center" gap="$4">
                                    <View style={style.box_icon}>
                                        <MaterialCommunityIcons name="comment-text-outline" size={18} color="black" />
                                    </View>
                                    <YStack>
                                        <Paragraph>Chat trực tuyến</Paragraph>
                                        <Paragraph maxWidth={200} fontSize={12} lineHeight={16} color={DefaultColor.slate[400]}>Đừng ngần ngại liên hệ với bộ pận hỗ trợ khách hàng của chúng tôi</Paragraph>
                                    </YStack>
                                </XStack>
                                <XStack gap="$2" alignItems="center">
                                    <FontAwesome6 name="angle-right" size={20} color={DefaultColor.slate[400]}/>
                            ...
                            <XStack alignItems="center" justifyContent="space-between" gap="$4" flex={1}>
                                <XStack alignItems="center" gap="$4">
                                    ...
                                    <YStack>
                                        ...
                                        <Paragraph maxWidth={200} fontSize={12} lineHeight={16} color={DefaultColor.slate[400]}>Giúp chúng tôi trở nên tốt hơn</Paragraph>
                                    </YStack>
                                </XStack>
                                <XStack gap="$2" alignItems="center">
                                    <FontAwesome6 name="angle-right" size={20} color={DefaultColor.slate[400]}/>
                        ...
                        <TouchableOpacity onPress={maintainWarning}>
                            <XStack alignItems="center" justifyContent="space-between" gap="$4" flex={1}>
                                <XStack alignItems="center" gap="$4">
                                    <View style={style.box_icon}>
                                        <MaterialCommunityIcons name="clipboard-check-multiple-outline" size={18} color="black" />
                                    </View>
                                    <YStack>
                                        <Paragraph>Giấy tờ pháp lý</Paragraph>
                                        <Paragraph maxWidth={200} fontSize={12} lineHeight={16} color={DefaultColor.slate[400]}>{APP_NAME} (SC) Ltd</Paragraph>
                                    </YStack>
                                </XStack>
                                <XStack gap="$2" alignItems="center">
                                    <FontAwesome6 name="angle-right" size={20} color={DefaultColor.slate[400]}/>
                            ...
                            <XStack alignItems="center" justifyContent="space-between" gap="$4" flex={1}>
                                <XStack alignItems="center" gap="$4">
                                    ...
                                    <YStack>
                                        ...
                                        <Paragraph maxWidth={200} fontSize={12} lineHeight={16} color={DefaultColor.slate[400]}>
                                            Vui lòng để lại đánh giá cho chúng tôi trên {Platform.OS === 'ios' ? 'App Store' : 'Google Play'}
                                        </Paragraph>
                                    </YStack>
                                </XStack>
                                <XStack gap="$2" alignItems="center">
