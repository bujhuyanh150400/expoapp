  ...
  return (
    ...
    >
      <YStack gap="$4" marginBottom="$4">
        ...
        <Paragraph>
          Vui lòng chọn chủ đề cho câu hỏi của bạn để chúng tôi có thể hỗ trợ
          tốt nhất.
        </Paragraph>
      </YStack>
      <YStack gap="$4">
        <TouchableOpacity onPress={() => nextStep(_SupportTicketType.PAYMENT)}>
          ...
          >
            ...
            <Paragraph>
              Vấn đề liên quan đến thanh toán, nạp tiền, rút tiền hoặc các giao
              dịch tài chính khác.
            </Paragraph>
          </Card>
        </TouchableOpacity>
        ...
        >
          ...
          >
            ...
            <Paragraph>
              Vấn đề liên quan đến giao dịch, đặt lệnh, hoặc các vấn đề kỹ thuật
        ...
        >
          ...
          >
            ...
            <Paragraph>
              Sự cố kỹ thuật, lỗi hệ thống, hoặc các vấn đề liên quan đến nền
              tảng giao dịch.
            </Paragraph>
          </Card>
        </TouchableOpacity>
