            ...
            >
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <Form
                        ...
                        <Paragraph theme="alt2" fontSize={20} fontWeight="bold">Vui lòng điền thông tin xác thực</Paragraph>
                        ...
                        <Controller
                            ...
                            render={({field: {onChange, onBlur, value}}) => (
                                <YStack gap="$2">
                                    <Label fontWeight={500} size="$2">Họ</Label>
                                    <Input
                                        id="first_name"
                                        placeholder="Họ"
                                        value={value ?? ""}
                        ...
                        <Controller
                            ...
                            render={({field: {onChange, onBlur, value}}) => (
                                <YStack gap="$2">
                                    <Label fontWeight={500} size="$2">Tên</Label>
                                    <Input
                                        id="last_name"
                                        placeholder="Tên"
                                        value={value ?? ""}
                        ...
                        <Controller
                            ...
                            render={({field: {onChange, onBlur, value}}) => (
                                <YStack gap="$2">
                                    <Label fontWeight={500}  size="$2">Số điện thoại</Label>
                                    <Input
                                        id="phone_number"
                        ...
                        <Controller
                            ...
                            render={({field: {onChange, onBlur, value}}) => (
                                <YStack gap="$2">
                                    <Label fontWeight={500}  size="$2">Địa chỉ</Label>
                                    <Input
                                        id="address"
                                        placeholder="Địa chỉ"
                                        value={value ?? ""}
                        ...
                        <Controller
                            ...
                            render={({ field: { onChange, value } }) => (
                                <YStack gap="$2">
                                    <Label fontWeight={500} size="$2">Ngày sinh:  {value ? `${dayjs(value).format('DD/MM/YYYY')}` : 'Chọn ngày sinh'}</Label>
                                    {!!errors.dob && (
                                        <Label color="red" size="$2">
                                            {errors.dob.message}
                                        </Label>
